...
public class CreditBureauIntegrationApiResource {
    ...
    public String addCreditReport(@Parameter(hidden = true) @FormDataParam("file") final File creditReport,
            @Parameter(hidden = true) @FormDataParam("file") InputStream uploadedInputStream,
            @Parameter(hidden = true) @FormDataParam("file") final UriInfo uriInfo,
