...
public class SelfClientsApiResource {
    ...
    public CommandProcessingResult addNewClientImage(@PathParam("clientId") final Long clientId,
            ...
            @Parameter(hidden = true) @FormDataParam("file") final InputStream inputStream,
            @Parameter(hidden = true) @FormDataParam("file") final FormDataContentDisposition fileDetails,
