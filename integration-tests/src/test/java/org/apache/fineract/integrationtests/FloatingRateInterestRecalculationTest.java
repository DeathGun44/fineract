...
public class FloatingRateInterestRecalculationTest extends FeignLoanTestBase {
    ...
    private Integer createCumulativeFloatingRateLoanProduct(Long floatingRateId, Account... accounts) {
        ...
        // Use FeignRawHttpHelper because PostLoanProductsRequest doesn't include floating rate fields
        // (floatingRatesId, interestRateDifferential, etc.), so deserialization via getLoanProductId silently drops
        // them
