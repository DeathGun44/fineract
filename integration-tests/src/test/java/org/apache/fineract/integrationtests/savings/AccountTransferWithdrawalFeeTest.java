...
public class AccountTransferWithdrawalFeeTest extends FeignSavingsTestBase {
    ...
    private final FeignAccountTransferHelper accountTransferHelper = new FeignAccountTransferHelper(
            FineractFeignClientHelper.getFineractFeignClient());
    private final FeignPaymentTypeHelper paymentTypeHelper = new FeignPaymentTypeHelper(FineractFeignClientHelper.getFineractFeignClient());
