...
public class LoanTransactionAuditingIntegrationTest extends FeignLoanTestBase {
    ...
    // Staff/User creation still requires REST-assured specs (admin-only infrastructure)
    ...
    public void checkAuditDates() throws InterruptedException {
        ...
        // Use internal API for audit fields (no Feign client binding for this internal endpoint)
        ...
        // Reverse using a different user — use REST-assured for the credential-switching reverse call
        this.requestSpec = new RequestSpecBuilder().setContentType(ContentType.JSON).build();
