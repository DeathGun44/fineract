...
public class FeignLoanHelper {
    ...
    public PostLoansLoanIdResponse rejectLoanByExternalId(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "reject"));
    }
    ...
    public PostLoansLoanIdResponse disburseToSavingsLoan(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "disburseToSavings"));
    }
    ...
    public Long createRescheduleRequest(PostCreateRescheduleLoansRequest request) {
        if (request instanceof LoanRequestBuilders.RescheduleRequestWithRecalculateInterest recalcRequest
            ...
            return createRescheduleRequestFromJson(toRescheduleJson(request, true));
        }
    ...
    public CallFailedRuntimeException createRescheduleRequestExpectingError(PostCreateRescheduleLoansRequest request) {
        if (request instanceof LoanRequestBuilders.RescheduleRequestWithRecalculateInterest recalcRequest
                && Boolean.TRUE.equals(recalcRequest.getRecalculateInterest())) {
            return fail(() -> createRescheduleRequestFromJson(toRescheduleJson(request, true)));
        }
        return fail(() -> fineractClient.rescheduleLoans().createLoanRescheduleRequest(request));
    }
    ...
    public PostLoansLoanIdResponse undoDisbursement(Long loanId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitions(loanId, request, Map.of("command", "undoDisbursal")));
    }
    ...
    public PostLoansLoanIdResponse approveLoan(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "approve"));
    }

    public PostLoansLoanIdResponse disburseLoan(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "disburse"));
    }

    public PostLoansLoanIdResponse undoApprovalLoan(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "undoapproval"));
    }

    public PostLoansLoanIdResponse undoDisbursalLoan(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "undodisbursal"));
    }

    public PostLoansLoanIdResponse withdrawnByApplicantLoan(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "withdrawnByApplicant"));
    }
    ...
    public PostLoansLoanIdResponse assignLoanOfficerByExternalId(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "assignLoanOfficer"));
    }

    public PostLoansLoanIdResponse unassignLoanOfficerByExternalId(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "unassignLoanOfficer"));
    }
    ...
    public PostLoansLoanIdResponse recoverGuaranteeByExternalId(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "recoverGuarantees"));
    }

    public PostLoansLoanIdResponse assignDelinquencyLoan(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "assignDelinquency"));
    }

    public PutLoansLoanIdResponse modifyLoanApplication(String loanExternalId, String command, PutLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().modifyLoanApplicationByExternalId(loanExternalId, request, command));
    }
    ...
    public java.util.List<org.apache.fineract.client.models.GetDelinquencyTagHistoryResponse> getLoanDelinquencyTags(
        ...
        return ok(() -> fineractClient.loans().getDelinquencyTagHistoryByExternalId(loanExternalId));
    }
    ...
    public PostLoansLoanIdResponse undoLastDisbursalLoan(String loanExternalId, PostLoansLoanIdRequest request) {
        return ok(() -> fineractClient.loans().stateTransitionsByExternalId(loanExternalId, request, "undolastdisbursal"));
    }
