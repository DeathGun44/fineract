...
public class SavingsProductCreationIntegrationTest extends FeignSavingsTestBase {
    ...
    public void testSavingsProductWithOverdraftUpdate_AllowsOverdraft() {
        ...
        final Long updatedProductId = savingsProductHelper
                .updateSavingsProduct(productId, SavingsRequestBuilders.withAccrualAccountingMappings(overdraftAccrualProductUpdate(),
    ...
    private PutSavingsProductsProductIdRequest overdraftAccrualProductUpdate() {
        final PostSavingsProductsRequest product = overdraftAccrualProduct();
